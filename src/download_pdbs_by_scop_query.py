...
Example:
./download_pdbs_by_scop_query a.118.1 -s /path/to/scop/2.07/dir.cla.scope.2.07-stable.txt -p /path/to/db/pdb
...
if __name__ == "__main__":
    ...
    ap.add_argument("-s", "--scop_dir_cla_file", type=str,
                    default=None,
                    help="part of the SCOP(e) database that contains the classification")
    ap.add_argument("-p", "--pdb_database", type=str, default=None,
    ...
    download_pdbs_by_scop_query(query=args.query,
                                ...
                                scop_dir_cla_file=args.scop_dir_cla_file)
